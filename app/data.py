...
FAQS = [
    {
        "id": 1,
        "question": "What is SCOM and how is it legally registered?",
        "answer": (
            "Service for Christ Outreach Ministry (SCOM) began operations in 2023 "
            "and was officially registered in 2025 under the Societies Act as a faith-based, "
            "non-profit organization in Kenya. We are dedicated to preaching the Gospel and providing "
            "holistic care to vulnerable children with disabilities and orphans."
        ),
    },
    {
        "id": 2,
        "question": "Where is SCOM located and what are your current facility challenges?",
        "answer": (
            "We are based in Ongata Rongai, Nairobi, Kenya (P.O. Box 9277 - 00200). We currently operate out of a "
            "rented structure hosting 25 full-boarding children. Because rental costs are high and space "
            "is limited, we have secured a piece of land and are raising funds to construct a "
            "permanent center that will accommodate up to 100 children."
        ),
    },
    {
        "id": 3,
    ...
    {
        "id": 5,
        "question": "Can I visit or volunteer at the training and care center?",
        "answer": (
            "Yes! We welcome volunteers, educators, therapy professionals, and well-wishers to support our staff,"
            "spend time with the children, or assist in our feeding and outreach programs."
            " Please reach out via email or phone to arrange a visit."
        ),
    },
    {
        "id": 6,
        "question": "How are families with special needs children enrolled or supported?",
        "answer": "We work directly with low-income families and community leaders in rural areas and informal settlements to identify children requiring care, offer parental guidance, and reduce local stigma around disabilities.",
    },
    {
        "id": 7,
...
PROGRAMS = [
    {
        ...
        "description": "Tailored special education curriculum and individualized learning paths designed by trained educators to meet the unique needs of children with physical, intellectual, and developmental challenges.",
    },
    {
        "id": 2,
        "title": "Physiotherapy & Occupational Therapy",
        "description": "Targeted physical and occupational therapy sessions aimed at improving mobility, strengthening motor skills, enhancing flexibility, and encouraging positive physical development.",
    },
    {
        "id": 3,
        "title": "Daily Nutrition & Feeding Program",
        "description": "A structured feeding initiative serving three well-balanced, nutritious meals daily to improve immunity, combat fatigue, and ensure optimal health outcomes during therapy.",
    },
    {
        "id": 4,
        "title": "Vocational & Life Skills Training",
        "description": "Practical hands-on training focused on daily living skills, personal care, and functional vocational tasks that build self-reliance and confidence for future independence.",
    },
    {
        "id": 5,
    ...
    {
        "id": 6,
        "title": "Spiritual Growth & Evangelism",
        "description": "Faith-based outreach grounded in Christian values, offering moral guidance, Bible lessons, and compassionate spiritual care to nurture each child's sense of purpose and worth.",
    },
]
...
VOLUNTEERING_FAQS = [
    {
        "id": 1,
        "question": "What volunteering opportunities are available at SCOM?",
        "answer": "Volunteers can assist special education teachers in the classroom, support physical and occupational therapy sessions, help caregivers during meal times, or assist with facility maintenance and outreach.",
    },
    {
        "id": 2,
        "question": "Do I need specialized experience to volunteer with special needs children?",
        "answer": "While medical, therapy, or special education backgrounds are valuable, anyone with a compassionate heart is welcome; our experienced staff provides guidance and orientation on-site.",
    },
    {
        "id": 3,
        "question": "Can churches, corporate teams, or groups volunteer together?",
        "answer": "Yes! We welcome church groups, corporate teams, and community organizations to host day-long activities, organize fun events, or assist with facility projects for our children.",
    },
    {
        "id": 4,
